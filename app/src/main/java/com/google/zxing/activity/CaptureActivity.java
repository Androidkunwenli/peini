        ...
        if (resultCode == RESULT_OK) {
            switch (requestCode) {
                case REQUEST_CODE_SCAN_GALLERY:
                    ...
                    Cursor cursor = getContentResolver().query(dataData, null, null, null, null);
...
////                                handler.sendMessage(m);
                            ...
                            String resultText = TextUtils.isEmpty(result.getText()) ? "" : result.getText();
...
////                                m.obj = "Scan failed!";
////                                handler.sendMessage(m);
//                                Toast.makeText(CaptureActivity.this, "二维码未扫描到结果", Toast.LENGTH_SHORT).show();
//                                CaptureActivity.this.finish();
//                            }
                        }
                    }).start();
    ...
    public Result scanningImage(String path) {
        ...
        try {
            ...
            e.printStackTrace();
            Log.i("你猜猜哪里错了", "scanningImage: " + e.getMessage());
        }
        return null;
    }
