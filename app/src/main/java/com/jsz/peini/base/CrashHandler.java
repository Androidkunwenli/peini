...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    //文件路径
    private static final String PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + "PEINI_CACHE";
    private static final String FILE_NAME = "jszpeinibug";
