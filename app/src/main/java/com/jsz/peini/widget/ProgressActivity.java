...
public class ProgressActivity extends RelativeLayout {
    ...
    private static final String TAG_SQUARE = "ProgressActivity.TAG_SQUARE";
    ...
    final String SQUARE = "type_square";
    ...
    FrameLayout mSquareErrorFrameLayout;
    ...
    TextView mTvSquareText;
    TextView errorStateButton;
    ImageView mIvSquareImage;
    ...
    int squareStateBackgroundColor;
    ...
    public void addView(@NonNull View child, int index, ViewGroup.LayoutParams params) {
        ...
        if (child.getTag() == null || (!child.getTag().equals(TAG_LOADING) && !child.getTag().equals(TAG_SQUARE) && !child.getTag().equals(TAG_EMPTY) && !child.getTag().equals(TAG_ERROR))) {
    ...
    public void showSquareNullData() {
        switchState(SQUARE, null, null, null, null, null, Collections.<Integer>emptyList());
    }

    public void showSquareNullData(Drawable drawable, String s) {
        switchState(SQUARE, drawable, s, null, null, null, Collections.<Integer>emptyList());
    }
    ...
    /**
     * Show error view with hong button when something goes wrong and prompting the user to try again
     *
    ...
    private void switchState(String state, Drawable drawable, String errorText, String errorTextContent,
        ...
        switch (state) {
            ...
            case SQUARE:
                ...
                setSquareView();
                mTvSquareText.setText(errorText);
                mIvSquareImage.setImageDrawable(drawable);
                setContentVisibility(true, skipIds);
                break;
        }
    }
    ...
    private void setSquareView() {
        if (mSquareErrorFrameLayout == null) {
            view = inflater.inflate(R.layout.dialog_requestdata, null);
            mSquareErrorFrameLayout = (FrameLayout) view.findViewById(R.id.square_error);
            mSquareErrorFrameLayout.setTag(TAG_SQUARE);
            mTvSquareText = (TextView) view.findViewById(R.id.tv_square_text);
            mIvSquareImage = (ImageView) view.findViewById(R.id.iv_square_image);

            //Set background color if not TRANSPARENT
            if (squareStateBackgroundColor != Color.TRANSPARENT) {
                this.setBackgroundColor(squareStateBackgroundColor);
            }
            layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.MATCH_PARENT);
            layoutParams.addRule(CENTER_IN_PARENT);
            addView(mSquareErrorFrameLayout, layoutParams);
        } else {
            mSquareErrorFrameLayout.setVisibility(VISIBLE);
        }
    ...
    private void hideSquareView() {
        if (mSquareErrorFrameLayout != null) {
            mSquareErrorFrameLayout.setVisibility(GONE);
