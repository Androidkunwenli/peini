...
public class MyAdapter extends BaseRecyclerViewAdapter {
    ...
    public void onBindBodyViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        vh.textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(activity, "我是内容体" + list.get(position), Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public RecyclerView.ViewHolder setBodyViewHolder(ViewGroup viewGroup) {
        return new MyViewHolder(View.inflate(activity, R.layout.seller_item_shopping, null));
    }
