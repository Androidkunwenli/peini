...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected TextView mTvMask;

    static final int ITEM_TAKE_PICTURE = 1;
    static final int ITEM_PICTURE = 2;
    static final int ITEM_LOCATION = 3;
    static final int ITEM_VIDEO = 11;
    static final int REQUEST_CODE_SELECT_VIDEO = 11;
    /**
     *加视频
     */
//    protected int[] itemStrings = {R.string.attach_take_pic, R.string.attach_picture, R.string.attach_video};
//    protected int[] itemdrawables = {R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector, R.drawable.em_chat_video_selector};
//    protected int[] itemIds = {ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_VIDEO};
    ...
    protected void initView() {
        ...
        mTvMask = (TextView) getView().findViewById(R.id.tv_mask);
     ...
     */
    private class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener {
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_LOCATION:
                    ...
                    break;
                case ITEM_VIDEO:
//                    Toast.makeText(getActivity(), "点击了视频的按钮", Toast.LENGTH_SHORT).show();
                    startActivityForResult(new Intent(getActivity(), ImageGridActivity.class), REQUEST_CODE_SELECT_VIDEO);
                    break;
    ...
    protected void selectPicFromCamera() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            outPutFileUri = Uri.fromFile(cameraFile);
        } else {
            outPutFileUri = FileProvider.getUriForFile(getContext(), "com.jsz.peini.fileprovider", cameraFile);//通过FileProvider创建一个content类型的Uri
