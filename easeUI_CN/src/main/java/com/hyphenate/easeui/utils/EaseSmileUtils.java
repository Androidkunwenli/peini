...
public class EaseSmileUtils {
    ...
    public static final String custom_ee_1 = "home_fefurbish";
    public static final String custom_ee_2 = "[(add)]";
    public static final String custom_ee_3 = "[(activity)]";
    public static final String custom_ee_4 = "[(message)]";
    ...
    static {
        ...
        for (EaseEmojicon emojicon : emojiconsCustom) {
            addPattern(emojicon.getEmojiText(), emojicon.getIcon());
        }
